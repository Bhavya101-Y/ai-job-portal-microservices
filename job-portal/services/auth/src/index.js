...
var producer_ts_1 = require("./producer.ts");
dotenv_1.default.config();
(0, producer_ts_1.connectKafka)();
exports.redisClient = (0, redis_1.createClient)({
    ...
    socket: {
        ...
        family: 4,
        reconnectStrategy: function (retries) { return Math.min(retries * 500, 5000); },
    },
    pingInterval: 15000,
});
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error("❌ Failed to connect to Redis:", err_1);
                    return [3 /*break*/, 3];
...
initDb().then(function () {
    app_ts_1.default.listen(process.env.PORT, function () {
        console.log("Auth service is running on http://localhost:".concat(process.env.PORT));
    });
});
